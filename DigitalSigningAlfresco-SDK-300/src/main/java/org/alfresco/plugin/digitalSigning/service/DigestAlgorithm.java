...
public enum DigestAlgorithm {
	 ...
	 */
	public static DigestAlgorithm DEFAULT = DigestAlgorithm.SHA256;
	 ...
	 */
	public static DigestAlgorithm forName(final String name) throws Exception {
		final String c14nName = name.replaceAll("-", "");
		final DigestAlgorithm algorithm = Registry.ALGORITHMS.get(c14nName);
		if (algorithm == null) {
			throw new Exception("Unsupported algorithm: " + name + "/" + c14nName);
		}
		return algorithm;
	}
	 ...
	 */
	public static DigestAlgorithm forOID(final String oid) throws Exception {
		final DigestAlgorithm algorithm = Registry.OID_ALGORITHMS.get(oid);
		if (algorithm == null) {
			throw new Exception("Unsupported algorithm: " + oid);
		}
		return algorithm;
	}
	 ...
	 */
	public static DigestAlgorithm forXML(final String xmlName) throws Exception {
		final DigestAlgorithm algorithm = Registry.XML_ALGORITHMS.get(xmlName);
		if (algorithm == null) {
			throw new Exception("Unsupported algorithm: " + xmlName);
		}
		return algorithm;
	}
